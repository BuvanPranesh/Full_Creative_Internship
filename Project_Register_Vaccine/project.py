...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'vaccine-booking-project.json'
app = Flask(__name__)
...
def search():
    ...
    with client.context():
        ...
        for i in res:
            res_li.append({"city": i.city, "vaccine_centre": i.vaccine_centre, "slots_available": i.slots_available})
